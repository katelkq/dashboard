...
with open('./Dashboard/lib/equcor_assets.pickle', 'wb') as handle:
...
with open('./Dashboard/lib/equcor_datacols.pickle', 'wb') as handle:
    pickle.dump(equcor_datacols, handle, protocol=pickle.DEFAULT_PROTOCOL)

with open('./Dashboard/lib/equcor_datatypes.pickle', 'wb') as handle:
    pickle.dump(pd.DataFrame.from_records(equcor_asset_class['datatypes']), handle, protocol=pickle.DEFAULT_PROTOCOL)

with open('./Dashboard/lib/equcor_freqs.pickle', 'wb') as handle:
...
with open('./Dashboard/lib/equesg_assets.pickle', 'wb') as handle:
...
with open('./Dashboard/lib/equesg_datacols.pickle', 'wb') as handle:
    pickle.dump(equesg_datacols, handle, protocol=pickle.DEFAULT_PROTOCOL)

with open('./Dashboard/lib/equesg_datatypes.pickle', 'wb') as handle:
    pickle.dump(pd.DataFrame.from_records(equesg_asset_class['datatypes']), handle, protocol=pickle.DEFAULT_PROTOCOL)

with open('./Dashboard/lib/equesg_freqs.pickle', 'wb') as handle:
...
with open('./Dashboard/lib/sectors.pickle', 'wb') as handle:
...
with open('./Dashboard/lib/tickers_by_sectors.pickle', 'wb') as handle:
...
with open('./Dashboard/lib/tickers.pickle', 'wb') as handle:
...
with open('./Dashboard/lib/score_types.pickle', 'wb') as handle:
